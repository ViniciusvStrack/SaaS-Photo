...
export function FadeInLeft({ children, className, ...props }: Props) {
  return (
    <motion.div
...
export function FadeInRight({ children, className, ...props }: Props) {
  return (
    <motion.div
      initial={{ opacity: 0, x: 40 }}
      whileInView={{ opacity: 1, x: 0 }}
...
export function ScaleIn({ children, className, ...props }: Props) {
  return (
    <motion.div
